...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO users (first_name, last_name, phone_number, email, password, gender, birth_date) 
    ...
    if ($stmt->execute()) {
        ...
        header("Location: success.html"); // เปลี่ยนเส้นทางไปยังหน้าสำเร็จ
        exit();
    } else {
